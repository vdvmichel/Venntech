...
class Inspectie_rapport_elektriciteit_model extends App_Model
{
    private string $table = "pc_inspectie_rapport_elektriciteit";
    private string $table_name = "Inspectie rapport elektriciteit";
    ...
    public function get_by_rapport_id($rapport_id)
    {
