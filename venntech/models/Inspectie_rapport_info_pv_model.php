...
class Inspectie_rapport_info_pv_model extends App_Model
{
    private string $table = "pc_inspectie_rapport_info_pv";
    private string $table_name = "Inspectie rapport info pv";
