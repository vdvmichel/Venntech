...
class Inspectie_rapport_algemeen_model extends App_Model
{
    private string $table = "pc_inspectie_rapport_algemeen";
    private string $table_name = "Inspectie rapport algemeen";
