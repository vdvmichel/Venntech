...
class Opleverdocument_installatie_model extends App_Model
{
    private string $table = "pc_opleverdocument_installatie";
    private string $table_name = "Opleverdocument installatie";
