...
class Opleverdocument_algemeen_model extends App_Model
{
    private string $table = "pc_opleverdocument_algemeen";
    private string $table_name = "Opleverdocument algemeen";
